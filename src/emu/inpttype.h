...
void construct_core_types_UI(simple_list<input_type_entry> &typelist)
{
	...
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_HISTORY,          "Show History",           input_seq(KEYCODE_LALT, KEYCODE_H) )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_MAMEINFO,         "Show Mameinfo/Messinfo", input_seq(KEYCODE_LALT, KEYCODE_M) )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_COMMAND,          "Show Command Info",      input_seq(KEYCODE_LALT, KEYCODE_C) )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_SYSINFO,          "Show Sysinfo",           input_seq(KEYCODE_LALT, KEYCODE_S) )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_FAVORITES,        "Add/Remove favorites",   input_seq(KEYCODE_LALT, KEYCODE_F) )
	INPUT_PORT_DIGITAL_TYPE( 0, UI,      UI_STORY,            "Show Story.dat",         input_seq(KEYCODE_LALT, KEYCODE_T) )
