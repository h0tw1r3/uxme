...
ui_menu_art_menu::art_option ui_menu_art_menu::m_options[] = {
	{ nullptr, nullptr },
...
ui_menu_art_menu::ui_menu_art_menu(running_machine &machine, render_container *container) : ui_menu(machine, container)
{
}
...
ui_menu_art_menu::~ui_menu_art_menu()
{
}
...
void ui_menu_art_menu::populate()
{
	UINT32 arrow_flags;
	emu_options::entry *entry;
	emu_options &mopts = machine().options();
...
void ui_menu_art_menu::custom_render(void *selectedref, float top, float bottom, float origx1, float origy1, float origx2, float origy2)
{
