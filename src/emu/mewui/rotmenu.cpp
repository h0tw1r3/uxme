...
ui_menu_rot_menu::rot_option ui_menu_rot_menu::m_options[] = {
	{ nullptr, nullptr },
...
ui_menu_rot_menu::ui_menu_rot_menu(running_machine &machine, render_container *container) : ui_menu(machine, container)
{
}
...
ui_menu_rot_menu::~ui_menu_rot_menu()
{
...
void ui_menu_rot_menu::populate()
{
	UINT32 arrow_flags;
	emu_options::entry *entry;
	emu_options &mopts = machine().options();
...
void ui_menu_rot_menu::custom_render(void *selectedref, float top, float bottom, float origx1, float origy1, float origx2, float origy2)
{
	float width, maxwidth = origx2 - origx1;
	ui_manager &mui = machine().ui();

	mui.draw_text_full(container, "Rotation Options", 0.0f, 0.0f, 1.0f, JUSTIFY_CENTER, WRAP_TRUNCATE,
	...
	mui.draw_text_full(container, "Rotation Options", x1, y1, x2 - x1, JUSTIFY_CENTER, WRAP_TRUNCATE,
