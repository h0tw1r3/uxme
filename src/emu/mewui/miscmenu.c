...
misc_option ui_menu_misc_options::m_options[] = {
	...
	{ 0, "Skip displaying disclaimer screen at startup",    OPTION_SKIP_DISCLAIMER_ENABLED },
	{ 0, "Skip displaying warning screen at startup",       OPTION_SKIP_WARNINGS_ENABLED },
	{ 0, "Skip displaying loading messages at startup",     OPTION_SKIP_LOADING_ENABLED },
