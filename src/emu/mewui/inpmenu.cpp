...
#include "ui/ui.h"
#include "ui/menu.h"
#include "mewui/inpmenu.h"
#include "mewui/utils.h"
#include <limits>

ui_menu_inp_menu::inp_option ui_menu_inp_menu::m_options[] = {
	{ nullptr, nullptr },
...
ui_menu_inp_menu::ui_menu_inp_menu(running_machine &machine, render_container *container) : ui_menu(machine, container)
{
}
...
ui_menu_inp_menu::~ui_menu_inp_menu()
{
}
...
void ui_menu_inp_menu::populate()
{
	UINT32 arrow_flags;
	emu_options::entry *entry;
	emu_options &mopts = machine().options();
...
void ui_menu_inp_menu::custom_render(void *selectedref, float top, float bottom, float origx1, float origy1, float origx2, float origy2)
{
