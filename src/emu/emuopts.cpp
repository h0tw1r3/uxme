...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_FASTSTART ";fs(0,1,2)",                     "1",         OPTION_INTEGER,    "fast forward machine startup. 0=Off 1=On 2=Extended." },
	...
	{ OPTION_RENDER_BORDER,                              "0",         OPTION_BOOLEAN,    "render white border on UI message screens" },
