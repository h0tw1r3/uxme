...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_SLEEP,                                      "0",         OPTION_BOOLEAN,    "enable sleeping, which gives time back to other applications when idle" },
	...
	{ OPTION_BEAM,                                       "3.0",       OPTION_FLOAT,      "set vector beam width" },
	...
	{ OPTION_MOUSE,                                      "1",         OPTION_BOOLEAN,    "enable mouse input" },
	{ OPTION_JOYSTICK ";joy",                            "1",         OPTION_BOOLEAN,    "enable joystick input" },
	{ OPTION_LIGHTGUN ";gun",                            "1",         OPTION_BOOLEAN,    "enable lightgun input" },
	...
	{ OPTION_ADSTICK_DEVICE ";adstick",                  "joystick",  OPTION_STRING,     "enable (none|keyboard|mouse|lightgun|joystick) if an analog joystick control is present" },
	...
	{ OPTION_DIAL_DEVICE ";dial",                        "mouse",     OPTION_STRING,     "enable (none|keyboard|mouse|lightgun|joystick) if a dial control is present" },
	{ OPTION_TRACKBALL_DEVICE ";trackball",              "mouse",     OPTION_STRING,     "enable (none|keyboard|mouse|lightgun|joystick) if a trackball control is present" },
	{ OPTION_LIGHTGUN_DEVICE,                            "lightgun",  OPTION_STRING,     "enable (none|keyboard|mouse|lightgun|joystick) if a lightgun control is present" },
	...
	{ OPTION_CHEAT ";c",                                 "1",         OPTION_BOOLEAN,    "enable cheat subsystem" },
	{ OPTION_SKIP_GAMEINFO,                              "1",         OPTION_BOOLEAN,    "skip displaying the information screen at startup" },
	{ OPTION_SKIP_DISCLAIMER,                            "1",         OPTION_BOOLEAN,    "skip disclaimer screen" },
	{ OPTION_SKIP_WARNINGS,                              "1",         OPTION_BOOLEAN,    "skip warning screen" },
