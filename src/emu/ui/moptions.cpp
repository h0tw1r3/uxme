...
const options_entry ui_options::s_option_entries[] =
{
	...
	{ OPTION_UI_SKIP_DISCLAIMER,            "0",            OPTION_BOOLEAN,         "skip disclaimer screen" },
	{ OPTION_UI_SKIP_WARNINGS,              "0",            OPTION_BOOLEAN,         "skip warning screen" },
	{ OPTION_UI_SKIP_LOADING,               "0",            OPTION_BOOLEAN,         "skip loading screen" },
	{ OPTION_UI_RENDER_BORDER,              "0",            OPTION_BOOLEAN,         "render white border around message screens" },
