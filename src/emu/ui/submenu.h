...
{
public:
	enum option_type { HEADER, COMMAND, SEPARATOR, EMU, UI, OSD };
...
static std::vector<ui_submenu::option> perf_submenu_options = {
	{ ui_submenu::HEADER,_("Performance Options") },
...
static std::vector<ui_submenu::option> rotate_submenu_options = {
	{ ui_submenu::HEADER,_("Rotation Options") },
...
static std::vector<ui_submenu::option> artwork_submenu_options = {
	{ ui_submenu::HEADER,_("Artwork Options") },
...
static std::vector<ui_submenu::option> state_submenu_options = {
	{ ui_submenu::HEADER,_("State/Playback Options") },
...
static std::vector<ui_submenu::option> input_submenu_options = {
	{ ui_submenu::HEADER,_("Input Options") },
