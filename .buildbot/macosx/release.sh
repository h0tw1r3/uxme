...
cp "$BIN/aueffectutil${EXE}" "$PKG"/tools/
# TODO: make a real installer or app bundle so this is not necessary
#       without it, the ini file will be stored in ~/Library/Application Data/uxme
#       and on second evocation, the working directory will be switched....
touch "$PKG"/uxme.ini
